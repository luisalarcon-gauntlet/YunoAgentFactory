...
function ArtifactCard({
  ...
  return (
    <div
      ...
      className="rounded-lg border border-border bg-card p-4 hover:border-primary/40 hover:bg-accent/30 transition-all cursor-pointer flex flex-col gap-3"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-4">
        ...
        <div className="space-y-3">
          ...
          {updateMutation.isError && (
            <div className="text-xs text-destructive">Failed to save changes</div>
          )}
        </div>
