      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="text-muted-foreground hover:text-foreground p-1.5 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
          ...
          <button
            ...
            className="text-muted-foreground hover:text-destructive p-1.5 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
